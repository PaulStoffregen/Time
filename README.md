...
setAdjustFunction(getAdjustFunction); // set external adjust function
```
...
if an external adjust function is setted, sysTime will be adjusted automatically on every time syncronization.
